        ...
        for attempt in range(retries):
            try:
                ...
                if period != "6mo":
                    ...
                    try:
                        # Convert cutoff to pandas Timestamp for consistent comparison
                        cutoff = pd.Timestamp(datetime.now().astimezone()) - pd.Timedelta(days=days)
                        ...
                        return pd.DataFrame(), f"Error filtering data for {ticker}: {str(e)}. Check period or API data."
